...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2024 a las 20:25:38
...
('                                       TITULO DEL AVISO', 'Detalle del envio cod 6, se envio con normalidad', 'Detalle del envio cod 7 se envio con normalidad', 'Se enviaran tecnicos a revisar fallas electricas', 'Se enviaron sillas nuevas', '', '');
...
(5, 4, 1, 'Centro de La Punta', '2024-04-24T15:00:57.536', 13, 2, 123213);
...
--
ALTER TABLE `registrovacunados`
  MODIFY `idRegistroVacunados` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
