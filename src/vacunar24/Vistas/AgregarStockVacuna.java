 ...
 * @author Jose
 */
public class AgregarStockVacuna extends javax.swing.JDialog {
    ...
    public AgregarStockVacuna(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        vac = new Vacuna();
        vacD = new VacunaData();
        lab = new Laboratorio();
    ...
    private void initComponents() {
        ...
        jCVac = new javax.swing.JComboBox<>();
        ...
        jLT.setText("AGREGAR STOCK VACUNAS");
        ...
        jPanel1.add(jTMedida, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 150, 140, -1));
        ...
        jPanel1.add(jCVac, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 360, -1));
    ...
    private void jBGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarActionPerformed
        try {
            vac = (Vacuna) jCVac.getSelectedItem();
            String marca = vac.getMarca();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarStockVacuna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarStockVacuna dialog = new AgregarStockVacuna(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox<Vacuna> jCVac;
